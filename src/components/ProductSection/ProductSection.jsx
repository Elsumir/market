...
import Product from './img/product5.webp';

export const ProductSection = () => (
  <section className={(cl(style.product__section), 'section--padding  pt-0')}>
    <div className='container'>
      <div
        className={
          (cl(style.section__heading, style.section__heading__flex),
      ...
      <div className={cl(style.product__section__inner)}>
        <div className='row row-md-reverse'>
          <div className='col-lg-3'>
            <div className={cl(style.sidebar__category)}>
              <div className={cl(style.choose__category__content)}>
                <h2 className={cl(style.choose__category__title)}>
                  Часто берут
                </h2>
                <ul className={cl(style.choose__category__menu)}>
                  <li className={cl(style.choose__category__menu__list)}>
                    <svg
                      className={cl(style.choose__category__menu__icon)}
                      width='7'
                      height='12'
                      viewBox='0 0 7 12'
                      fill='none'
                    ...
                    <a
                      className={cl(style.choose__category__menu__link)}
                      href='shop.html'
                    >
                      Аккумуляторы
                    </a>
              ...
              <div
                className={cl(
                  style.choose__category__banner,
                  'position__relative'
                )}
              >
                <a
                  className={
                    (cl(style.banner__thumbnail),
                    'banner__thumbnail display-block')
                  }
                  href='shop.html'
                >
                  <Image
                    className={cl(style.banner__thumbnail__img)}
                    src={Banner}
                    alt='banner-img'
                  />

                  <div className={cl(style.category__banner__content)}>
                    <span
                      className={cl(
                        style.category__banner__subtitle,
                        'text__secondary'
                      )}
                    >
                      Акция
                    </span>
                    <h2 className={cl(style.category__banner__title)}>
                      ШИНОМОНТАЖ
                    </h2>
                    <p className={cl(style.category__banner__desc)}>
                      цена за замену 4+1
                    </p>
                    <span
                      className={cl(
                        style.category__banner__price,
                        'text__secondary'
                      )}
                    >
                      500 &#8381;
                      ...
                      <article className={cl(style.product__card)}>
                        <div className={cl(style.product__card__thumbnail)}>
                          ...
                          >
                            <Image
                              className={cl(
                                style.product__card__thumbnail__img
                              )}
                              src={Product}
                              alt='product-img'
                            />
                        ...
                        <div className={cl(style.product__card__content)}>
                          <h3 className={cl(style.product__card__title)}>
                            <a href='product-details.html'>Филтр</a>
                          </h3>
                          <div className={cl(style.product__card__price)}>
                            <span className={cl(style.current__price)}>
                              239.52 &#8381;
                            </span>
                            <span className={cl(style.old__price)}>
                              {' '}
                              362.00 &#8381;
                            </span>
                          </div>
